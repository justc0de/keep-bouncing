function init() {
	...
	world.CreateBody(bodyDef).CreateFixture(fixDef);
	 ...
	 // This is where you load the image data - make it a 50px x 50px
	 // image
	 // You should use some sort of pre-loader to make sure the
	 // image is loaded prior to using it.
	 var image = new Image();
	 image.src = "image.png";
	...
	document.removeEventListener("mousemove", handleMouseMove, true);
	 ...
	 function update() {
	   ...
	   //This needs to be fine tuned to draw exactly on the debug ball
